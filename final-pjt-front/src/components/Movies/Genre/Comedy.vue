<template>
  <div style="margin-bottom: 5rem;">
    ...
    <carousel-3d v-if="comedy.length" :autoplay=true :autoplayTimeout=5000 :display=7 :space=220 :width=210 :height=300 :controls-visible="true" @after-slide-change="movieIndex">
